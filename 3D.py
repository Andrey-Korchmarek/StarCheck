...
class Game(Ursina):
    ...
    def palette(self):
        Entity(model='models/Solid', position=Vec3(0, 0, 0), color=color.black)
        Entity(model='models/Cell', position=Vec3(0, 4, 0), color=color.blue)
        Entity(model='models/Cell', position=Vec3(4, 0, 0), color=color.blue)
        Entity(model='models/Cell', position=Vec3(0, 0, 4), color=color.blue)
        Entity(model='models/Cell', position=Vec3(0, -4, 0), color=color.blue)
        Entity(model='models/Cell', position=Vec3(-4, 0, 0), color=color.blue)
        Entity(model='models/Cell', position=Vec3(0, 0, -4), color=color.blue)
        Entity(model='models/Cell', position=Vec3(2, 2, 2), color=color.green)
        Entity(model='models/Cell', position=Vec3(-2, 2, -2), color=color.green)
        Entity(model='models/Cell', position=Vec3(-2, -2, 2), color=color.green)
        Entity(model='models/Cell', position=Vec3(2, -2, -2), color=color.green)
        Entity(model='models/Cell', position=Vec3(-2, -2, -2), color=color.red)
        Entity(model='models/Cell', position=Vec3(2, -2, 2), color=color.red)
        Entity(model='models/Cell', position=Vec3(-2, 2, 2), color=color.red)
        Entity(model='models/Cell', position=Vec3(2, 2, -2), color=color.red)
